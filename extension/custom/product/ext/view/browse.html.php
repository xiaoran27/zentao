...
<?php include '../../../../../module/common/view/datatable.fix.html.php';?>
<style>
    ...
    if(!commonModel::isTutorialMode())
    {
        foreach(customModel::getFeatureMenu($this->app->rawModule, $this->app->rawMethod) as $menuItem)
        {
            ...
            elseif($menuItem->name == 'QUERY')
            {
                ...
                include '../../../../../module/common/view/querymenu.html.php';
            }
            else
            {
...
<div id="mainContent" class="main-row fade">
  ...
  <div class="main-col">
    ...
    <form class="main-table table-story skip-iframe-modal" method="post" id='productStoryForm'>
      ...
      if($useDatatable) include '../../../../../module/common/view/datatable.html.php';
      include '../../../../../module/common/view/sortable.html.php';
