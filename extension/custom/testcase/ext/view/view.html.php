        ...
        <div class="detail-content">
          <table class='table table-condensed table-hover table-striped table-bordered' id='steps'>
            ...
            foreach($case->steps as $stepID => $step)
            {
                ...
                echo "<div class='detail-content article-content'>" . nl2br(str_replace(' ', ' ', $step->desc)) . "</div></div></td>";
                echo "<td class='text-left'><div class='detail-content article-content'>" . nl2br(str_replace(' ', ' ', $step->expect)) . "</div></td>";
                echo "</tr>";
                $childId ++;
            }
            ?>
