...
{
    $config->bug->list->customBatchCreateFields = 'project,execution,steps,type,pri,purchaser,occursEnv,feedbackTime,collectTime,deadline,severity,os,browser,keywords';
}
else
{
    $config->bug->list->customBatchCreateFields = 'execution,steps,type,pri,purchaser,occursEnv,feedbackTime,collectTime,deadline,severity,os,browser,keywords';
}
