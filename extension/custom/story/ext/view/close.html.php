    ...
    <form method='post' target='hiddenwin'>
      <table class='table table-form'>
        <tr>
          ...
          <tr>
              <th class='thWidth'><?php echo $lang->story->prdReviewTime;?></th>
              <td class='w-p25-f'><?php echo html::input('prdReviewTime', helper::isZeroDate($story->prdReviewTime) ? '' : substr($story->prdReviewTime, 0, 10), "class='form-control form-date'");?></td>
          </tr>
          <tr>
              <th class='thWidth'><?php echo $lang->story->releaseTime;?></th>
              <td class='w-p25-f'><?php echo html::input('releaseTime', helper::isZeroDate($story->releaseTime) ? '' : substr($story->releaseTime, 0, 10), "class='form-control form-date'");?></td>
          </tr>
