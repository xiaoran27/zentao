...
$lang->story->prCategoryList['support']  = '产品支持';
...
$lang->story->prCategoryList0['support']  = '产品支持';
// $lang->story->prCategoryList0['new'] = '新产品需求';

$lang->story->prCategoryList0_pr = array();
$lang->story->prCategoryList0_pr['']  = '';
$lang->story->prCategoryList0_pr['work_ticket']  = '智能工单';
$lang->story->prCategoryList0_pr['service_plugin']  = '客服插件';
$lang->story->prCategoryList0_pr['service_hall']  = '服务大厅';
$lang->story->prCategoryList0_pr['workflow']  = '流程中台';
$lang->story->prCategoryList0_pr['knowledge']  = '知识库';
$lang->story->prCategoryList0_pr['examination']  = '考试系统';
$lang->story->prCategoryList0_pr['template']  = '模板中心';
$lang->story->prCategoryList0_pr['work_todo']  = '工作台&代办';
$lang->story->prCategoryList0_pr['call_center']  = '人工&AI外呼';
$lang->story->prCategoryList0_pr['ai_evalution']  = '人工智能评价';
$lang->story->prCategoryList0_pr['batch_transfer']  = '批量转账';
$lang->story->prCategoryList0_pr['taobao_refund']  = '淘宝退款管理';
$lang->story->prCategoryList0_pr['douyin_aftersales']  = '抖音售后';
$lang->story->prCategoryList0_pr['pinduoduo_aftersales']  = '拼多多售后';
$lang->story->prCategoryList0_pr['promotion_mgt']  = '活动管理';
$lang->story->prCategoryList0_pr['data_dashbaord']  = '数据看板';
$lang->story->prCategoryList0_pr['security']  = '安全改造';
$lang->story->prCategoryList0_pr['platform_connect']  = '电商平台对接';
$lang->story->prCategoryList0_pr['bytenew_openapi']  = '班牛OPENAPI';
$lang->story->prCategoryList0_pr['bytenew_admin']  = '班牛ADMIN';
$lang->story->prCategoryList0_pr['bytenew_starlink']  = '星链CRM';
$lang->story->prCategoryList0_pr['super_performance']  = '超级绩效';

$lang->story->prCategoryList0_support = array();
$lang->story->prCategoryList0_support['']  = '';
$lang->story->prCategoryList0_support['solution_offering']  = '解决方案提供';
$lang->story->prCategoryList0_support['evaluate_viability']  = '可行性评估';
$lang->story->prCategoryList0_support['evaluate_workload']  = '工作量评估';
$lang->story->prCategoryList0_support['delivery_product']  = '产品交付';
$lang->story->prCategoryList0_support['delivery_erp']  = 'ERP交付';
$lang->story->prCategoryList0_support['delivery_wangdiantong']  = '旺店通交付';
$lang->story->prCategoryList0_support['delivery_jushuitan']  = '聚水潭交付';
$lang->story->prCategoryList0_support['delivery_e3']  = '百胜E3交付';
$lang->story->prCategoryList0_support['delivery_wanliniu']  = '万里牛交付';
$lang->story->prCategoryList0_support['delivery_juyi']  = '巨益交付';
$lang->story->prCategoryList0_support['delivery_guanyiyun']  = '管易云交付';
