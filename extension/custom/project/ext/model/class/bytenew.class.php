...
class bytenewProject extends projectModel
{
        ...
        if ($col->show) {
            ...
            switch ($id) {
                ...
                case 'hasProduct':
                    ...
                    break;
                case 'stage':
                    echo zget($this->lang->project->stageList, $project->stage);
                    break;
                case 'budget':
                    echo $budgetTitle;
                    break;
                ...
                case 'poDays':
                    ...
                    break;
                case 'outerDays':
                    echo $project->outerDays;
                    break;
                case 'selfDays':
                    echo $project->selfDays;
                    break;
                case 'saasDays':
