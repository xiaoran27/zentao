        ...
        <form class='form-indicator main-form form-ajax' method='post' target='hiddenwin' id='dataform'>
            <table class='table table-form'>
                    ...
                    <td class='futureBox'>
                        <div class='checkbox-primary'>
                            <input type='checkbox' id='future' name='future'
                                   value='1' <?php if ($project->budget == 0) echo 'checked'; ?> />
                ...
                <tr>
                    ...
                    ?>
                    <td id="endList"
                        colspan='2'><?php echo html::radio('delta', $lang->project->endList, $deltaValue, "onclick='computeEndDate(this.value)'"); ?></td>
                </tr>
                <tr id='daysBox' <?php if ($project->end == LONG_TIME) echo "class='hidden'"; ?>>
                    ...
                    <td>
                        <div class='input-group'>
                            ...
                            <?php echo html::input('devEvaluate', $project->devEvaluate, "class='form-control' style='width: 150px'"); ?>
                        </div>
                    </td>
                    <td></td>
                </tr>
                ...
                <tr>
                    ...
                    <td colspan='3'
                        class='aclBox'><?php echo nl2br(html::radio('acl', $aclList, $project->acl, "onclick='setWhite(this.value);'", 'block')); ?></td>
                </tr>
