                ...
                <div class="pull-right btn-toolbar">
                    <?php if ($config->edition != 'max' or $model == 'kanban'): ?>
                        <button type='button' class='btn btn-link' data-toggle='modal'
                                data-target='#copyProjectModal'><?php echo html::icon($lang->icons['copy'], 'muted') . ' ' . $lang->project->copy; ?></button>
                    <?php else: ?>
                        <button type='button' class='btn btn-link open-btn' data-toggle='modal'
                                data-target='#maxCopyProjectModal'><?php echo html::icon($lang->icons['copy'], 'muted') . ' ' . $lang->project->copy; ?></button>
                    <?php endif; ?>
                </div>
            <?php endif; ?>
        </div>
        <form class='form-indicator main-form form-ajax' method='post' target='hiddenwin' id='dataform'>
            <table class='table table-form'>
                <tr class='<?php echo !empty($globalDisableProgram) ? 'hidden' : ''; ?>'>
                    ...
                    <td>
                        <icon class='icon icon-help' data-toggle='popover' data-trigger='focus hover'
                              data-placement='right' data-tip-class='text-muted popover-sm'
                              data-content="<?php echo $lang->program->tips; ?>"></icon>
                    </td>
                    <td></td>
                </tr>
                <tr>
                                    ...
                                    <div class="col-sm-6">
                                        <div class='input-group' <?php echo "id='plan$i'"; ?>>
                                            ...
                                            <div class='input-group-btn'>
                                                <a href='javascript:;' onclick='addNewLine(this)'
                                                   class='btn btn-link addLine'><i class='icon-plus'></i></a>
                                                <a href='javascript:;' onclick='removeLine(this)'
                                                   class='btn btn-link removeLine' <?php if ($i == 0) echo "style='visibility: hidden'"; ?>><i
                ...
                <?php else: ?>
                    <tr>
                        ...
                        <div><icon class='icon icon-help' data-toggle='popover' data-trigger='focus hover'
                                   data-placement='left' data-tip-class='text-muted popover-sm'
                                   data-content="<?php echo $lang->project->productTip; ?>"></icon></div>
                      </span>
                                                <?php endif; ?>
                                            </div>
                                        </div>
                                    ...
                                    <div class='input-group' id='plan0'>
                                        ...
                                        <div class='input-group-btn'>
                                            <a href='javascript:;' onclick='addNewLine(this)'
                                               class='btn btn-link addLine'><i class='icon-plus'></i></a>
                                            <a href='javascript:;' onclick='removeLine(this)'
                                               class='btn btn-link removeLine' style='visibility: hidden'><i
                                                        class='icon-close'></i></a>
                                        </div>
                                    </div>
                                </div>
                ...
                <?php if ($model == 'waterfall' or $model == 'waterfallplus'): ?>
                    <tr class='hide division'>
                        ...
                        <td>
                            ...
                            <icon class='icon icon-help' data-toggle='popover' data-trigger='focus hover'
                                  data-placement='right' data-tip-class='text-muted popover-sm'
                                  data-content="<?php echo $lang->project->divisionTips; ?>"></icon>
                        </td>
                    </tr>
                <?php endif; ?>
                <?php if ($model == 'kanban'): ?>
                ...
                <tr>
                    ...
                    <td colspan='3'
                        class='aclBox'><?php echo nl2br(html::radio('acl', $lang->project->aclList, $acl, "onclick='setWhite(this.value);'", 'block')); ?></td>
                </tr>
            ...
            <?php else: ?>
                <div id='copyProjects' class='row'>
                    <?php foreach ($copyProjects as $id => $name): ?>
                        ...
                        <div class='col-md-4 col-sm-6'><a href='javascript:;' data-id='<?php echo $id; ?>'
                                                          class='nobr <?php echo $active; ?>'><?php echo html::icon($lang->icons['project'], 'text-muted') . ' ' . $name; ?></a>
                        </div>
                    <?php endforeach; ?>
                </div>
            <?php endif; ?>
